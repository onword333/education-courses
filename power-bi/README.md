...
## Привязка данных
TREATAS - функция позволяет менять привязку данных по столбцам
...
Функция TREATAS позволила переопределить привязку данных в анонимной таблице, это привело к возможности выполнить фильтрацию. Правила выполнения привязки данных очень просты. Обычная ссылка на столбец поддерживает привязку к таблице, тогда как выражение всегда будет
