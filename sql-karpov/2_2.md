...
Вариант 1
    ...
    SELECT
      ads_campaign,
      cac,
      ROUND(SUM(revenue) OVER(partition BY ads_campaign ORDER BY dt) / paying_users :: DECIMAL, 2) AS cumulative_arppu,
...
### Визуализация
![визуализация 2_2_m_6](./img/2_2_m_6_vis.jpg)

Какой вывод можно сделать на основе построенных графиков?
